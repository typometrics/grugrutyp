...
const EXAMPLE_SECTIONS = [
  {
    ...
    items: [
      ...
      { label: 'Relation and POS together',
        ...
        ud: 'pattern { V [upos=VERB]; V -[1=nsubj]-> P [upos=PRON] }' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Adjective before noun',
        ...
        ud: 'pattern { N [upos=NOUN]; N -[1=amod]-> A [upos=ADJ] }\nwith { A << N }' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Two objects on one verb',
        ...
        ud: 'pattern { V -[1=obj]-> O1; V -[1=obj]-> O2; O1 << O2 }' },
      { label: 'Coordination of unlikes',
        sud: 'pattern { X -[1=conj]-> Y; X [upos=NOUN]; Y [upos=VERB] }',
        ud: 'pattern { X -[1=conj]-> Y; X [upos=NOUN]; Y [upos=VERB] }' },
    ],
  },
]
